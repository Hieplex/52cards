...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        thongbao=(TextView)findViewById(R.id.txtthongbao4);
        tenla1=(TextView)findViewById(R.id.txtthongbao);
        tenla2=(TextView)findViewById(R.id.txtthongbao2);
        tenla3=(TextView)findViewById(R.id.txtthongbao3);
        rutbai.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                thongbao.setText("Cac la da rut \n"+cacladarut.toString()
                        +chuoithongbao +"\nba tay "+batay);
                tenla1.setText(""+cacladarut.get(0).toString());
                String checktenla1 = tenla1.getText().toString();
                int check = 0 ;
                int check2 = 2 ;
                String checktenla2 = tenla1.getText().toString();
                int list = cacladarut.size();
                if (list == 1)
                {
                    return ;
                }
                if(list == 2)
                {
                    ...
                    {
                        check++;
                        tenla2.setText(""+cacladarut.get(1).toString());
                ...
                if(list == 3)
                {
                    for (int i = 0; i <= cacladarut.size(); i++ )
                    {
                        ...
                        tenla3.setText(""+cacladarut.get(2).toString());
                    }
                }
